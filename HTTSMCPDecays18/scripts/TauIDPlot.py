#python scripts/TauIDPlot.py --tauidplot  --file tauid_shapes/shapes_MC_1.root --mode postfit --x_title "m_{vis} (GeV)" --ratio
...
parser.add_argument('--y_title', default='Events',help='Title for the y-axis')
...
if args.tauidplot:
  background_schemes['mt'] = [backgroundComp("t#bar{t}",["TTT","TTJ"],ROOT.TColor.GetColor(155,152,204)),backgroundComp("QCD", ["QCD"], ROOT.TColor.GetColor(250,202,255)),backgroundComp("Electroweak",["VVT","VVJ","W"],ROOT.TColor.GetColor(222,90,106)),backgroundComp("Z#rightarrow#mu#mu",["ZL","ZJ"],ROOT.TColor.GetColor(100,192,232)),backgroundComp("Z#rightarrow#tau#tau",["EmbedZTT","ZTT"],ROOT.TColor.GetColor(248,206,104))]
