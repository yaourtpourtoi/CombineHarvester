...
#plot.DrawTitle(pads[0], '41.2 fb^{-1} (13 TeV)', 3)
# plot.DrawTitle(pads[0], '77.1 fb^{-1} (13 TeV)', 3)
#plot.DrawTitle(pads[0], '137.2 fb^{-1} (13 TeV)', 3)
#plot.DrawTitle(pads[0], '101.3 fb^{-1} (13 TeV)', 3)
plot.DrawTitle(pads[0], '101.3 fb^{-1} extrap. to 137.2 fb^{-1} (13 TeV)', 3)
